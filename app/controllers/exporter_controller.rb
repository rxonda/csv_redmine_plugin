class ExporterController < ApplicationController
  ...
  def export
	...
	@fim = params[:dataTermino]
  	if params[:dataInicio] || !params[:dataInicio].strip.empty? then
  		if !params[:dataTermino] || params[:dataTermino].strip.empty?
  	...
  	elsif !params[:dataTermino] || params[:dataTermino].strip.empty?
